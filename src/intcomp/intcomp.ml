...
(** Checking whether an expression is closed. The vs is a list of the bound
    variables. *)
...
(** Stack machine instructions. An expressions in postfix or reverse Polish
    form is a list of stack machine instructions. *)
type rinstr =
  | RCstI of int
  | RAdd
  | RSub
